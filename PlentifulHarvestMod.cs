...
namespace PlentifulHarvest {
    ...
    public class PlentifulHarvestMod : BaseUnityPlugin {
        ...
        private void LoadConfig() {
            ...
            } catch (FileNotFoundException ex) { Logger.LogInfo("Couldn't find PlentifulHarvestConfig.txt, using default settings instead. Error: " + ex.Message); } catch (Exception ex) { Logger.LogInfo("Couldn't read PlentifulHarvestConfig.txt, using default settings instead. Error: " + ex.Message); }
        }
